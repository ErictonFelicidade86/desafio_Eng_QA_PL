...
Os Endpoint GET e POST que serão testados:
 ...
 | POST   | /users   | Deve garantir que o tempo de resposta seja menor que 500ms                                                       | Body Válido    | Seja menor tempo que 500ms  | A API atendeu o tempo de resposta esperada menos de 500ms|✅ Aprovado     | 
 ...
 | GET    | /users   | Deve garantir que o tempo de resposta seja menor que 200ms                                                       | Sem entrada    | Seja menor tempo que 500ms  | A API atendeu o tempo de resposta esperada menos de 200ms|⚠️ Aprovado com observação   | 
 | GET    | /users   | Deve garantir que o tempo de resposta seja menor que 500ms                                                       | Sem entrada    | Seja menor tempo que 500ms  | A API atendeu o tempo de resposta esperada menos de 500ms|✅ Aprovado     | 
